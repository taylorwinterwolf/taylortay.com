    ...
    return (
        <div className="introWrapper section" id='home'>
            <div className="container-lg">
                ...
                <div className="row justify-content-center mb-4">
                     <div className="col-4 col-sm-4 col-md-3 col-lg-2"><img src={bootstrapImg} className='img-fluid' alt='bootstrap logo'/></div>
                ...
                <div className="row justify-content-center mb-4">
                    <div className="col-4 col-sm-4 col-md-3 col-lg-2"><img src={lighthouseImg} className='img-fluid' alt='lighthouse logo'/></div>
                    <div className="col-12 col-md-9 col-lg-8">
                ...
                <div className="row justify-content-center mb-4">
                    <div className="col-3 col-sm-3 col-md-3 col-lg-2"><img src={jquery} className='img-fluid' alt="react js logo"/></div>
                    <div className="col-12 col-md-9 col-lg-8">
                ...
                <div className="row justify-content-center">
                    <div className="col-4 col-sm-4 col-md-3 col-lg-2"><img src={githubImg} className='img-fluid' alt='github logo'/></div>
                    <div className="col-12 col-md-9 col-lg-8">
